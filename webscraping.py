...
def web_scraper(url, cursor):
    ...
    for car in cars:
        ...
        if not (len(database_list) == 0):
            ...
            cursor.execute(query)
            print("query for setting date is ok DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD")
            for s in cursor:
                print("##################################")
                print(s)
                print("##################################")
            ...
            cursor.execute(query)
            print("query for setting Time is ok TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT")
            for s in cursor:
                s=s[0]
                print("##################################")
                print(s)
        ...
        if(len(raw_list)==8):
            ...
            if(len(database_list) == 0):
                ...
                if((not len(database_list)== 0) and (date_comparing(lastdate,raw_list[7]) and time_comparing(lasttime,raw_list[7]))):
                    
                    updat_help = update
                    update = canUpdate(raw_list)
                    print(updat_help)
                    print(update)
                    print("updaet is Valis UPDAT UPDATE UPDATE")
                print(updat_help)
                print(update)
                if(update):
                    print("adding to DB")
                    ...
                    cnx.commit()
                    print("added to DB")
                elif(not(updat_help and update)):
                    flag = False
                    break
                else:
                    continue
